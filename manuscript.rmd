...
# Multiple pairwise comparisons between species can strongly mislead functional genomics studies
...
```{r show_contrast_result, echo=FALSE, cache=TRUE, message=F, warning=F, fig.height=2, fig.width=5, fig.cap="Density plot of the magnitude of phylogenetic independent contrast values following duplication and speciation events. As the contrasts for duplication events are not larger than those of speciation events, the results are not consistent with the predictions of the ortholog conjecture."}
...
```{r Tau_v_max, cache=TRUE, echo=FALSE, warning=FALSE, dev="png", dpi=300, message=FALSE, fig.cap="There is a negative relationship between Tau and the maximum observed expression for each gene."}

...
```{r preliminaries, echo=FALSE, message=F, warning=F}
	...
	# Name of the compara gene trees file
...
```{r prep_trees, echo=FALSE, cache=TRUE, message=F, warning=F}
	...
	# Parse the node ages from the internal @phylo object and store them with the 
...
```{r show_result, echo=FALSE, cache=TRUE, message=F, warning=F}
	...
	# Check if the mean rank of duplication pics is greater than speciation pics
	wilcox_test_result = 
		wilcox.test( 

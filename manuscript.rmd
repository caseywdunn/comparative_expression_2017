...
```{r estimate_tau_model, cache=TRUE, echo=FALSE, fig.cap="XX_PIC_VAR", warning=FALSE, message=FALSE}
...
```{r Tau_v_max, cache=TRUE, echo=FALSE, warning=FALSE, message=FALSE, dev="png", fig.cap="There is a negaative relationship between Tau and the maximum observed expression for each gene."}

...
```{r define_functions, echo=FALSE, message=F, warning=F}
	...
	add_model_parameters = function( nhx, ... ) {
		...
		nhx@phylo$model = fitContinuous( phy, tau_original, ... )
...
```{r show_contrast_result, echo=FALSE, cache=TRUE, message=F, warning=F, fig.height=2, fig.width=4, fig.cap="Phylogneetic reanalysis of the Tau values calculated by KMRR [@KryuchkovaMostacci:2016iw]. Density plot of the magnitude of phylogenetic independent contrasts for Tau following duplication and speciation events. As the contrasts for duplication events are not larger than those of speciation events, the results are not consistent with the predictions of the ortholog conjecture."}
...
Thanks to Steve Haddock, Alex Damian Serrano, and August Guang for feedback on the manuscript. This work was supported by the National Science Foundation (DEB-1256695 and the Waterman Award).

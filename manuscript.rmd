...
```{r define_functions, echo=FALSE, message=F, warning=F}
	...
	summarize_contrasts = function( gene_trees_pic ) {
		...
		nodes_all$Event = NA
		nodes_all$Event[ nodes_all$D == "Y" ] = "Duplication"
		nodes_all$Event[ nodes_all$D == "N" ] = "Speciation"
...
```{r example_trees, cache=TRUE, echo=FALSE, fig.cap="XX_PIC_VAR", warning=FALSE, message=FALSE}
	...
	example_trees = lapply( 
		...
		function( x ){
				...
				nhx@data$Event = NA
				nhx@data$Event[ nhx@data$D == "Y" ] = "Duplication"
				nhx@data$Event[ nhx@data$D == "N" ] = "Speciation"

...
```{r preliminaries, echo=FALSE, message=F, warning=F}
	...
	calibrate_tree = function ( nhx, calibration_times ) {
			...
			tree = try( 
				ape::chronos( nhx@phylo, calibration=calibration, model="correlated" ) 
			)

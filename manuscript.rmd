...
There has been considerable recent intrest in, and controversy about, the ortholog conjecture [@Koonin:2005fp; @Studer:2009bm; @Nehrt:2011bm; @Gabaldon:2013fi]. Our reanalysys is consistent with multiple studies that have not found support for the ortholog conjecture in comparative analyses of gene ontology [@Studer:2009bm; @Nehrt:2011bm] or gene expression [@Yanai:2004hk]. A previous study of expression concluded that there was strong support for the ortholog conjecture , though like KMRR it used pairwise comparisons. 

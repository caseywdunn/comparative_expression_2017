...
<<<<<<< HEAD
=======
> Supplementary Figure XX_TAU_V_EXP | There is a negative relationship between Tau and the maximum observed expression for each gene.
>>>>>>> d038d43be2fdafaed0f62453215acf6cbe41e69d
...
```{r Tau_v_max, cache=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="There is a negaative relationship between Tau and the maximum observed expression for each gene."}

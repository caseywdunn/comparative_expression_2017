...
```{r Tau_v_max, cache=TRUE, echo=FALSE, warning=FALSE, dev="pdf", dpi=300, message=FALSE, fig.cap="Genes with higher maximum observed expression tend to have lower Tau. The blue line is the linear model for the relationship between the two."}
